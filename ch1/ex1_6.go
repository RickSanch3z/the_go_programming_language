// !!! Important: if you are running this program under "Windows" OS,
// use "cmd.exe" instead of "PowerShell". "PowerShell" did not produce
// a correct .gif file to execute.
...
func lissajous(out io.Writer) {
	...
	gif.EncodeAll(out, &anim)	// NOTE: ignoring ecnoding errors
}
